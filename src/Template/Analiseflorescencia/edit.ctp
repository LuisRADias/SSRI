<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $analiseflorescencium->analiseflorescenciaid],
                ['confirm' => __('Are you sure you want to delete # {0}?', $analiseflorescencium->analiseflorescenciaid)]
            )
        ?></li>
...
<div class="analiseflorescencia form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Analiseflorescencium') ?></legend>
        <?php
