<div class="actions columns large-2 medium-3">
    <h3><?= __('Menu') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Listar liberações'), ['controller' => 'liberacao', 'action' => 'index']) ?></li>
    </ul>
</div>
<div class="separacaoliberacao index large-10 medium-9 columns">
    ...
    <?php foreach ($separacaoliberacao as $separacaoliberacao): ?>
        <tr>
            ...
            <td class="actions">
                <!-- <?= $this->Html->link(__('Visualizar'), ['action' => 'view', $separacaoliberacao->separacaoliberacaoid]) ?> <br> -->
                <?= $this->Html->link(__('Editar'), ['action' => 'edit', $separacaoliberacao->separacaoliberacaoid]) ?> <br>
                <?= $this->Form->postLink(__('Deletar'), ['action' => 'delete', $separacaoliberacao->separacaoliberacaoid], ['confirm' => __('Tem certeza de que deseja deletar: # {0}?', $separacaoliberacao->separacaoliberacaoid)]) ?> <br>
            </td>
        </tr>
