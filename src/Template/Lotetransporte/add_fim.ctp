...
<div class="lotetransporte form large-10 medium-9 columns">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('data_recebimento', array('empty' => false, 'default' => ''), ['label' => 'Data do recebimento']);
            echo $this->Form->input('hora_chegada_lemi', ['type' => 'time', 'label' => 'Horário de chegada lemi']);
            echo $this->Form->input('qtd_c25_completas_recebimento', ['label' => 'Quantidade de c25 completas recebidas']);
            echo $this->Form->input('qtd_celulas_incompletas_recebimento', ['label' => 'Quantidade de células incompletas recebidas']);
            echo $this->Form->input('nome_encarregado_montagem_rd11', ['label' => 'Nome do encarredado da Montagem rd11']);
            ...
            echo $this->Form->input('qnt_celula_rd11', ['label' => 'Quantidade de célula rd11']);
            echo $this->Form->input('qnt_rd11_montadas', ['label' => 'Quantidade de rd11 montadas']);
            echo $this->Form->input('qnt_total_machos_enviados', ['label' => 'Quantidade total de machos enviados']);
        ?>
    </fieldset>
