...
<div class="subdivisao index large-10 medium-9 columns">
    ...
    <?php foreach ($subdivisao as $subdivisao): ?>
        <tr>
            ...
            <td class="actions">
                <!--<?= $this->Html->link(__('View'), ['action' => 'view', $subdivisao->subdivisaoid]) ?> <br> -->
                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $subdivisao->subdivisaoid]) ?> <br>
                <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $subdivisao->subdivisaoid], ['confirm' => __('Are you sure you want to delete # {0}?', $subdivisao->subdivisaoid)]) ?> <br>
            </td>
        </tr>
